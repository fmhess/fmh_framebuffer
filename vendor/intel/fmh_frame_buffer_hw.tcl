...
# Sat May 30 23:02:53 EDT 2020
# DO NOT MODIFY


# 
# fmh_frame_buffer "fmh_frame_buffer" v1.0
#  2020.05.30.23:02:53
# 
# 
...
# 
# module fmh_frame_buffer
# 
set_module_property DESCRIPTION ""
set_module_property NAME fmh_frame_buffer
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property GROUP "DSP/Video and Image Processing"
set_module_property AUTHOR ""
set_module_property DISPLAY_NAME fmh_frame_buffer
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL fmh_frame_buffer
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property QUARTUS_SYNTH ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file fmh_frame_buffer.vhd VHDL PATH ../../src/fmh_frame_buffer.vhd TOP_LEVEL_FILE


# 
# parameters
# 
add_parameter bits_per_symbol POSITIVE 8
...
set_parameter_property bits_per_symbol TYPE POSITIVE
set_parameter_property bits_per_symbol UNITS None
set_parameter_property bits_per_symbol ALLOWED_RANGES 1:2147483647
set_parameter_property bits_per_symbol HDL_PARAMETER true
add_parameter symbols_per_pixel_per_plane POSITIVE 4
set_parameter_property symbols_per_pixel_per_plane DEFAULT_VALUE 4
set_parameter_property symbols_per_pixel_per_plane DISPLAY_NAME symbols_per_pixel_per_plane
set_parameter_property symbols_per_pixel_per_plane TYPE POSITIVE
set_parameter_property symbols_per_pixel_per_plane UNITS None
set_parameter_property symbols_per_pixel_per_plane ALLOWED_RANGES 1:2147483647
set_parameter_property symbols_per_pixel_per_plane HDL_PARAMETER true
add_parameter symbols_per_beat POSITIVE 4
...
set_parameter_property symbols_per_beat TYPE POSITIVE
set_parameter_property symbols_per_beat UNITS None
set_parameter_property symbols_per_beat ALLOWED_RANGES 1:2147483647
set_parameter_property symbols_per_beat HDL_PARAMETER true
add_parameter beats_per_pixel POSITIVE 1
set_parameter_property beats_per_pixel DEFAULT_VALUE 1
set_parameter_property beats_per_pixel DISPLAY_NAME beats_per_pixel
set_parameter_property beats_per_pixel TYPE POSITIVE
set_parameter_property beats_per_pixel UNITS None
set_parameter_property beats_per_pixel ALLOWED_RANGES 1:2147483647
set_parameter_property beats_per_pixel HDL_PARAMETER true
...
add_parameter memory_burstcount_width POSITIVE 4
set_parameter_property memory_burstcount_width DEFAULT_VALUE 4
...
add_interface_port video_out video_out_data data Output bits_per_symbol*symbols_per_beat
...
# 
# connection point memory_clock
# 
add_interface memory_clock clock end
set_interface_property memory_clock clockRate 0
set_interface_property memory_clock ENABLED true
set_interface_property memory_clock EXPORT_OF ""
set_interface_property memory_clock PORT_NAME_MAP ""
set_interface_property memory_clock CMSIS_SVD_VARIABLES ""
set_interface_property memory_clock SVD_ADDRESS_GROUP ""

add_interface_port memory_clock memory_clock clk Input 1


# 
# connection point memory_reset
# 
add_interface memory_reset reset end
set_interface_property memory_reset associatedClock memory_clock
set_interface_property memory_reset synchronousEdges DEASSERT
set_interface_property memory_reset ENABLED true
set_interface_property memory_reset EXPORT_OF ""
set_interface_property memory_reset PORT_NAME_MAP ""
set_interface_property memory_reset CMSIS_SVD_VARIABLES ""
set_interface_property memory_reset SVD_ADDRESS_GROUP ""

add_interface_port memory_reset memory_reset reset Input 1
...
set_interface_property memory_master associatedClock memory_clock
set_interface_property memory_master associatedReset memory_reset
